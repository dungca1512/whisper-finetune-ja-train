...
Examples:
  python infer_from_hf.py --repo_id dungca/whisper-tiny-ja --audio ./audio.wav
  python infer_from_hf.py --repo_id dungca/whisper-tiny-ja-ct2-int8 --audio ./audio.mp3
  HF_TOKEN=hf_xxx python infer_from_hf.py --repo_id dungca/whisper-tiny-ja --audio ./audio.wav --language ja
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--repo_id",
        required=True,
        help="Hugging Face model repo id, e.g. dungca/whisper-tiny-ja",
    )
    parser.add_argument(
        "--audio",
        required=True,
