...
echo "  python train.py --model_size small --push_to_hub --hub_adapter_model_id <repo_owner>/whisper-small-ja-lora --hub_model_id <repo_owner>/whisper-small-ja --no_wandb"
echo ""
